...
This is the automatic start page for version *{page-component-version}* of Component A.

Component A is one of two documentation components in the Antora Demo.
